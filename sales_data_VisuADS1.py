# -*- coding: utf-8 -*-
"""
Created on Sun Mar  5 20:29:45 2023
...
# Loading the Data
sales = pd.read_csv("D:\\Dataset\\sales_data_sample.csv",encoding='latin1')
...
def plot_monthly_revenue(sales1):
    ...
    plt.plot(monthly_revenue[monthly_revenue['year_id'] == 2003]['month_id'], 
             monthly_revenue[monthly_revenue['year_id'] == 2003]['sales'], label='2003')
    plt.plot(monthly_revenue[monthly_revenue['year_id'] == 2004]['month_id'], 
             monthly_revenue[monthly_revenue['year_id'] == 2004]['sales'], label='2004')
    plt.plot(monthly_revenue[monthly_revenue['year_id'] == 2005]['month_id'], 
             monthly_revenue[monthly_revenue['year_id'] == 2005]['sales'], label='2005')
